...
public class userLogin extends HttpServlet
{
	public void doGet(HttpServletRequest srq,HttpServletResponse srp) throws IOException,ServletException
	{
		...
		{		
		if(UN.equals("admin"))
			srp.sendRedirect("http://localhost:8080/supermarket/reporthome.html");
		else
		                  srp.sendRedirect("http://localhost:8080/supermarket/billerhome.html");
				
		}
		else
		{
		srp.sendRedirect("http://localhost:8080/supermarket/invalid.html");
		}
